...
@Entity
public class NumBagObjectGeconstateerd {

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "num_bag_object_geconstateerd_seq")
    @SequenceGenerator(name = "num_bag_object_geconstateerd_seq", sequenceName = "num_bag_object_geconstateerd_seq")
    private Integer id;
