...
@Entity
public class NumBagObjectDocumentdatum {

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "num_bag_object_documentdatum_seq")
    @SequenceGenerator(name = "num_bag_object_documentdatum_seq", sequenceName = "num_bag_object_documentdatum_seq")
    private Integer id;
