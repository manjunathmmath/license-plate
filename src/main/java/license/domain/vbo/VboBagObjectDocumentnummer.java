...
@Entity
public class VboBagObjectDocumentnummer {

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "vbo_bag_object_documentnummer_seq")
    @SequenceGenerator(name = "vbo_bag_object_documentnummer_seq", sequenceName = "vbo_bag_object_documentnummer_seq")
    private Integer id;
