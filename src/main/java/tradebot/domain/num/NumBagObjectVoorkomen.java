...
@Entity
public class NumBagObjectVoorkomen {

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "num_bag_object_voorkomen_seq")
    @SequenceGenerator(name = "num_bag_object_voorkomen_seq", sequenceName = "num_bag_object_voorkomen_seq")
    private Integer id;
