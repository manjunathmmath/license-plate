<div class="row ">
    ...
    <div class="col-md-2">
        <input class="btn btn-warning btn-sm" type="submit" value="Load" id="load-data">
    </div>
    <div class="col-md-2">
        <input class="btn btn-warning btn-sm" type="submit" value="Show" id="show-data">
    </div>
</div>
